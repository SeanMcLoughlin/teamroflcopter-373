...
STATIC const PINMUX_GRP_T pinmuxing[] = {
	{0,  0,   IOCON_MODE_INACT | IOCON_FUNC2},	/* TXD3 */ // lcd pins
	{0,  1,   IOCON_MODE_INACT | IOCON_FUNC2},	/* RXD3 */

	{0,  9,   IOCON_MODE_INACT | IOCON_FUNC0},	/* TXD3 */
	{0,  8,   IOCON_MODE_INACT | IOCON_FUNC0},	/* RXD3 */
	{0,  7,   IOCON_MODE_INACT | IOCON_FUNC0},	/* TXD3 */
	{0,  6,   IOCON_MODE_INACT | IOCON_FUNC0},	/* RXD3 */
	{0, 18, IOCON_MODE_INACT | IOCON_FUNC0},	/* RXD3 */  // touch screen power pin
	...
	{0, 27, IOCON_MODE_INACT | IOCON_FUNC0},	/* JOYSTICK_DOWN */
	{0, 28, IOCON_MODE_INACT | IOCON_FUNC0},	/* JOYSTICK_DOWN */
												// touch screen adc pins
	{0, 23, IOCON_MODE_INACT | IOCON_FUNC0},	/* JOYSTICK_PRESS */
	{0, 24, IOCON_MODE_INACT | IOCON_FUNC0},	/* JOYSTICK_DOWN */
	{0, 25, IOCON_MODE_INACT | IOCON_FUNC1},	/* JOYSTICK_PRESS */
	{0, 26, IOCON_MODE_INACT | IOCON_FUNC1},	/* JOYSTICK_DOWN */

	//read tx and rx
	{0, 2, IOCON_MODE_INACT | IOCON_FUNC0},	/* JOYSTICK_PRESS */
	{0, 3, IOCON_MODE_INACT | IOCON_FUNC0},	/* JOYSTICK_DOWN */

	{1, 30, IOCON_MODE_INACT | IOCON_FUNC3},	/* JOYSTICK_DOWN */
	{1, 31, IOCON_MODE_INACT | IOCON_FUNC3},	/* JOYSTICK_DOWN */
